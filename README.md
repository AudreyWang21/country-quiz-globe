...
Map data from [Natural Earth](https://www.naturalearthdata.com/) (public domain). Flags from [flag-icons](https://github.com/lipis/flag-icons) (MIT). Rendered with [D3](https://d3js.org/).

This is a generated mirror of the app folder of a private project; issues and PRs aren't monitored.
